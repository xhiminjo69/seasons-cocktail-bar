...
const labCocktails = [
  {
    ...
    description:
      "Malic acid strips the gin bare, leaving only its most essential character. Celery bitter sharpens the edge while basil and cucumber air float above it all — light, strange, unforgettable.",
  ...
  },
  {
    number: "002",
    name: "Lotus",
    method: "Jasmine Air Technique",
    ingredients: [
      "Mezcal Ilegal",
      "Pineapple & Peppercorn Cordial",
      "Lime",
      "Jasmine Air",
    ],
    description:
      "Smoke and tropical sweetness from mezcal and pineapple, punctuated by the heat of peppercorn. The jasmine air on top transforms every sip into something closer to perfume than cocktail.",
  ...
  },
  {
    number: "003",
    name: "Midnight Bloom",
    method: "Cold-Pressed Cordial",
    ingredients: [
      "Dark Rum",
      "Chokeberry & Lavender Cordial",
      "White Penja Pepper",
      "Honey",
    ],
    description:
      "Chokeberry and lavender cold-pressed to preserve their raw intensity. Dark rum and honey pull it toward warmth while white Penja pepper delivers a finish that lingers like a night you won't forget.",
    image: "/images/cocktailbest.jpeg",
    objectPosition: "object-[center_20%]",
  },
  {
    number: "004",
    name: "Negroni Rinforzato",
    method: "Multi-Amaro Layering",
    ingredients: [
      "Carpano, Luxardo Bitter, Amaro",
      "Gin",
      "Blackberry & Thyme Cordial",
      "Paragon White Penja Pepper",
    ],
    description:
      "Three bitter Italian spirits layered with surgical precision. Blackberry and thyme cordial weave through the structure while white Penja pepper seals every sip with a slow, deliberate heat.",
...
export default function LaboratoryPage() {
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <AnimatedSection direction="up" className="max-w-xl">
            ...
            <h1 className="font-display font-light text-ivory leading-none mb-6 text-shadow-md"
              style={{ fontSize: "clamp(3.5rem, 13vw, 10rem)" }}>
              The<br />
              <em className="text-gold">Lab</em>
            </h1>
            <p className="font-sans text-sm text-ivory/80 leading-loose max-w-sm">
      ...
      {/* MANIFESTO */}
      <section className="bg-night py-16 sm:py-28 md:py-44 border-b border-white/5">
      ...
      {/* VIDEO SECTION */}
      <section className="bg-night-2 py-14 md:py-28">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] gap-0">
                  ...
                  <div className="p-6 sm:p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex items-center gap-4 mb-3">
                      <span className="font-display text-5xl sm:text-6xl font-light text-gold/25 leading-none">
                        {cocktail.number}
                      </span>
                    </div>
                  ...
                  <div className="p-6 sm:p-8 md:p-12 flex flex-col justify-center border-t md:border-t-0 md:border-l border-white/5">
                    <p className="font-sans text-[10px] tracking-widest2 uppercase text-ivory/45 mb-4">
                      Components
                    </p>
      ...
      <section className="relative overflow-hidden flex items-center justify-center h-[58vh] md:h-auto md:aspect-[21/9] border-t border-white/5">
        ...
        <AnimatedSection direction="none" className="relative z-10 w-full text-center px-6">
          ...
          <p
            className="font-display font-light italic text-ivory/90 max-w-2xl mx-auto leading-relaxed text-balance text-shadow-sm"
